...
function Card({ item }: CardProps) {
  ...
  const item_filepath = FileUtils.ForwardSlash(item.toString());
  ...
  return (<>
    <div class="certificationItemCard">
...
export default function Page() {
  ...
  const items = FileUtils.ListDir("public/res/certifications", {
    ...
    return FileUtils.GetFilename(a) < FileUtils.GetFilename(b) ? 1 : -1;
  });


  console.log("Certifications items:", items);

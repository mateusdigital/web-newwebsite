    ...
    <>
      <DefaultPage_ page_id="about">
        ...
        <AboutSection_ title="latino americano!" photo="srs_1">
          <p>I'm from a small city called Santa Rita do Sapucai, in the State of Minas Gerais, Brasil!</p>

          <p>Nos primeiros 28 anos de minha vida eu vivi e conheci muitos lugares. Minha cidade natal, Contagem, Belo Horizonte, Jundiai, Cajamar, Curitiba, Sao Paulo,</p>

          <p>Eu tive algumas bandas quando jovem e fiz amigos que carrego hoje.</p>

          <p>Em 2010 eu entrei para o curso de Ciencia da Computacao em Belo Horizonte, a capital do meu estado. Embora nao tenha concluido o curso, foi nesse periodo que entrei no Microsoft Inovation Center (MicBH).</p>

          <p>No MicBH eu trabalhei ativamente com, o entao novo, Windows Phone. Alem de pequenos jogos e aplicativos que foram desenvolvidos (eu ganhei 2 lumias novinhos por fazer alguns jogos) eu trabhei bastente com conteudos educacionais sobre a platforma.</p>

          <p>Este esforco me valeu o titulo de Microsoft Student Partner a qual fui pelo periodo de 2 anos (2011-2013). Durante esste tempo eu tive a oportunidade de palestrar em diversos centros academicos e universidades, em especial na Universdade Federal de Itajuba, No Instutudo de Telecomuicacoes e Pontificia Universade Catolica de Minas Gerais - e outros.</p>

          <p>Esse foi um periodo de muito estudo no qual me resulto em duas certificoes da Microsoft:</p>
